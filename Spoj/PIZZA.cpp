...
if(cn&1)
{
    ...
    {
        lp[(double)1/4]-=2;
    }else if(lp[(double)1/4])
    {
        lp[(double)1/4]--;
    }
}
int cur_coun = lp[(double)3/4];
ans+= cur_coun;
int mini= Min(cur_coun,lp[(double)1/4]);
lp[(double)1/4]-=mini;
cur_coun=lp[(double)1/4];
ans+= (cur_coun)/4;
if(cur_coun%4)
{
    ans++;
